 ...
 */
    ...
    public static void main (String[] args){
        ...
        WebElement webElement4 = driver.findElement(By.cssSelector(".s-nav-item__name"));
        if (webElement4.getText().equals("VIA_20220418")){
            System.out.println("Осуществлён успешный вход под пользователем VIA_20220418.\nТест пройден.");
        }
        else {
        ...
        //Ищем кнопку Выйти и выходим из ЖЖ для этого придётся использовать Actions
        Actions actions = new Actions(driver);
        actions.moveToElement(webElement4).perform();

        WebElement webElement5 = driver.findElement(By.cssSelector(".s-header-sub-list-item__link--logout"));
        webElement5.click();
